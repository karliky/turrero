...
1. Add tweet to CSV: `node scripts/add-new-tweet.js $id $first_tweet_line`
2. Scrape: `deno --allow-all scripts/recorder.ts`
3. Enrich: `node scripts/tweets_enrichment.js`
4. Generate cards: `node scripts/image-card-generator.js`
5. Move metadata: `mv scripts/metadata/* public/metadata/`
6. Update Algolia: `node scripts/make-algolia-db.js`
7. Generate books: `node scripts/generate-books.js`
8. Enrich books: `node scripts/book-enrichment.js`
...
- Search database generated by `make-algolia-db.js`
