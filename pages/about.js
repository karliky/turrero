        ...
        <div className={styles.content}>
          <div className={styles.person}>
            <div className={styles.person__text}>
              ...
              <div className={styles.person__description}>Cuando era joven, su objetivo era convertise en ingeniero informático y trabajó en varios puestos relacionados con la tecnología.
            ...
            <div className={styles.person__image}><img className={styles.boss} src="https://gurulibros.com/wp-content/uploads/2021/09/javier_g_recuenco.jpg"></img></div>
          </div>
          <div className={styles.person}>
          <div className={styles.person__image}><img src="https://avatars.githubusercontent.com/u/881069?v=4"></img></div>
            <div className={styles.person__text}>
              ...
              <div className={styles.person__description}>Crecí entrando en zonas secretas de videojuegos. Siempre he sentido curiosidad por saber más sobre el mundo fuera del mío. 
          ...
          <div className={styles.person}>
            ...
            <div className={styles.person__image}><img src="https://secuora.es/wp-content/uploads/2020/06/toni-dorta-equipo-secuora-370x370.jpg"></img></div>
          </div>
          <div className={styles.person}>
          <div className={styles.person__image}><img src="https://avatars.githubusercontent.com/u/8669176?v=4"></img></div>
            <div className={styles.person__text}>
