export default function Footer() {
    return <div className="footer">
        ...
        <span className="small">Creado con Next.js y ChatGPT. Algunos textos han sido generados por una Inteligencia Artificial y pueden no ser precisos o contener errores.</span>
    </div>;
}