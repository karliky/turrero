export default function Header({ children, totalTweets }) {
    ...
    <h1><a href="/">El <span className="brand">Turrero Post</span></a></h1>
    ...
    <h3>Hay un total de {totalTweets} turras, la última actualización fue el {`${new Date().toLocaleDateString("es-ES")}`}.</h3>
    {children && children()}
    <style jsx>{`
    .header h1 a {
